...
public class DoctorApi {
    ...
    public ResponseEntity<DoctorDto> updateDoctorPhoto(@RequestBody DoctorPhotoUpdateDto photoUpdateDto)
            throws HmsException {
        return new ResponseEntity<>(doctorService.updateDoctorPhoto(photoUpdateDto), HttpStatus.OK);
    }
    ...
    @GetMapping("/getAllDoctorsDropdownById")
    public ResponseEntity<List<DoctorDropdown>> getAllDoctorsDropdownById(@RequestParam List<UUID> ids)
            throws HmsException {
        return new ResponseEntity<>(doctorService.getAllDoctorDropdownsByIds(ids), HttpStatus.OK);
    }
