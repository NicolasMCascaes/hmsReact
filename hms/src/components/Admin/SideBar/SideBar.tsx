...
const Links = [
  { name: "Painel", url: "/admin/dashboard", icon: <IconLayoutGrid stroke={1.5} /> },
  { name: "Pacientes", url: "/admin/patients", icon: <IconMoodHeart stroke={1.5} /> },
  {name: "Médicos", url: "/admin/doctors", icon: <IconHeartbeat stroke={1.5} /> },
  { name: "Medicamentos", url: "/admin/medicines", icon: <IconVaccine stroke={1.5} /> },
  {name: "Estoque", url: "/admin/inventory", icon: <IconBox stroke={1.5} /> },
  {name: "Vendas", url: "/admin/sales", icon: <IconBrandCashapp stroke={1.5} /> },
]
const SideBar = () => {
